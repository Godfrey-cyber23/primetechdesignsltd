...
The module uses the existing Firebase app; it does not contain credentials. The project-forms behavior is currently included in `assets/js/dashboard.js`, which runs after Firebase initialization on the dashboard page.
